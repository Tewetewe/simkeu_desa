                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        ...
                        <div class="row align-items-right">
                            <div class="col-8">
                            <a href="{{url('/detailpendapatan/create/'.$detailtransaksis[0]->id_transaksi)}}" class="btn btn-success" data-container="body" data-toggle="popover" data-color="info" data-placement="top">Tambahan Detail Pendapatan</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @for ($i = 1; $i <= sizeof($detailtransaksis); $i++)
                                        <tr>
                                            ...
                                            <td> {{"Rp ".number_format($detailtransaksis[$i-1]->harga,0,",",".")  }}</td>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{url('/detailpendapatan/edit/'.$detailtransaksis[0]->id_detail_transaksi)}}" class="btn btn-info" data-container="body" data-toggle="popover" data-color="info" data-placement="top">Sunting</a>
                                            </td>
                                            <td>
                                                <form action="/detailpendapatan/delete/{{$detailtransaksis[$i-1]->id_detail_transaksi}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
