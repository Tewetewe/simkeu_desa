                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h2 class="mb-0">Detail Transaksi Pengeluaran Desa</h2>
                            </div>
                        </div>
                    </div>
                     ...
                     <form action="/detailpengeluaran/create/{{$transaksi->id_transaksi}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input required class="form-control" type="number" name="jumlah" id="example-text-input" >
                            </div>
                                      <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="example-text-input">Keterangan (Masukkan Keterangan Detail Pengeluaran)</label>
