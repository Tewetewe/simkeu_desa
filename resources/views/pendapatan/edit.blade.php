                     ...
                     <div class="p-4 bg-secondary">
                        <form action="/pendapatan/{{$pendapatan->id_pendapatan}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input required class="form-control" type="text" name="nobukti" id="example-text-input" required value={{$pendapatan->no_bukti}}>
                            </div>
                            <div class="form-group">
                                <label for="example-text-input">Nominal (Masukkan Nominal Pendapatan)</label>
                                <input required class="form-control" type="number" name="nominal" id="example-text-input" required value={{$pendapatan->nominal}}>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control datepicker" type="text" name= "tanggal" required value={{$pendapatan->tanggal}}>
                                </div>
                            </div>
                            <div class="form-group">
